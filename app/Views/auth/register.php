    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 mt-2">Join AuthBoard today</p>
            </div>
            ...
            <form method="POST" action="/register" class="space-y-5">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        I agree to the 
                        <a href="#" class="text-green-600 hover:text-green-500 font-medium">Terms and Conditions</a> 
                        and 
                ...
                <button 
                    type="submit" 
                    class="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
                >
                    Create Account
                </button>
            ...
            <p class="text-center text-sm text-gray-600">
                ...
                <a href="/login" class="font-semibold text-green-600 hover:text-green-500">
                    Sign in instead
                </a>
            </p>
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Your data is secure</h3>
                    <p class="text-xs text-blue-700 mt-1">We use industry-standard encryption to protect your information.</p>
                </div>
            </div>
        </div>
    </div>
